...
class DirectMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direct_message" do
    assert_difference('DirectMessage.count') do
      post direct_messages_url, params: { direct_message: { body: @direct_message.body, reciever_id: @direct_message.reciever_id, sender_id: @direct_message.sender_id } }, as: :json
    end
  ...
  test "should update direct_message" do
    patch direct_message_url(@direct_message), params: { direct_message: { body: @direct_message.body, reciever_id: @direct_message.reciever_id, sender_id: @direct_message.sender_id } }, as: :json
    assert_response 200
  end
